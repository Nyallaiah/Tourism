...
function Login(){
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>TOURISAM AND HOSPITALITY</div>
                ...
                <div id='login' className='popup'>
                    <div id='popupwindow' className='popupwindow' style={popupwindowstyle} >
                        ...
                        <div className='loginstyle2'>
                            ...
                            <div>Forget Password <label classNAme='linklabel' onClick={registration}>forgetpassword</label></div>
                        </div>
                    </div>
                </div>
            ...
            <div id='footer' className='loginfooter'>Copyright @TOURISAM AND HOSPITALITY. All rights reserved.</div>
        </div>
    );
}
